...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
        ...
        button1.setOnTouchListener(new Button.OnTouchListener(){
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch(event.getAction()){
                    case MotionEvent.ACTION_DOWN: globals.button_state_1_1 = globals.assigned_button_letter_11;
                                                globals.button_state_1_2=globals.assigned_button_letter_12;
                    break;
                    case MotionEvent.ACTION_UP: globals.button_state_1_1 = null;
                        globals.button_state_1_2 = null;
                    break;
                }
                return false;
            }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch(event.getAction()){
                    case MotionEvent.ACTION_DOWN: globals.button_state_2_1 = globals.assigned_button_letter_21;
                        ...
                        break;
                    case MotionEvent.ACTION_UP: globals.button_state_2_1 = null;
                        globals.button_state_2_2 = null;
                        break;
                }
                return false;
            }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch(event.getAction()){
                    case MotionEvent.ACTION_DOWN: globals.button_state_3_1 = globals.assigned_button_letter_31;
                        ...
                        break;
                    case MotionEvent.ACTION_UP: globals.button_state_3_1 = null;
                        globals.button_state_3_2 = null;
                        break;
                }
                return false;
            }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch(event.getAction()){
                    case MotionEvent.ACTION_DOWN: globals.button_state_4_1 = globals.assigned_button_letter_41;
                        ...
                        break;
                    case MotionEvent.ACTION_UP: globals.button_state_4_1 = null;
                        globals.button_state_4_2 = null;
                        break;
                }
                return false;
            }
    ...
    public void senddata(){
        ...
        textView1.setText(globals.Data[8]);
        textView2.setText(globals.Data[9]);
        textView3.setText(globals.Data[0]+globals.Data[1]);
        textView4.setText(globals.Data[2]+globals.Data[3]);
        textView5.setText(globals.Data[4]+globals.Data[5]);
        textView6.setText(globals.Data[6]+globals.Data[7]);
    ...
    private void Data_set(){
        globals.Data[0]=globals.button_state_1_1;
        globals.Data[1]=globals.button_state_1_2;
        globals.Data[2]=globals.button_state_2_1;
        globals.Data[3]=globals.button_state_2_2;
        globals.Data[4]=globals.button_state_3_1;
        globals.Data[5]=globals.button_state_3_2;
        globals.Data[6]=globals.button_state_4_1;
        globals.Data[7]=globals.button_state_4_2;
        globals.Data[8]=String.valueOf(attitude[1]);
        globals.Data[9]=String.valueOf(attitude[2]);
    }
